...
This is a project containing a public app, so developers can get up and running on HubSpot Developer Projects. For HubSpotters, your developer account will need to be ungated to [Developers:ProjectPublicAppsLaunch](https://tools.hubteam.com/gates/gates/Developers%3AProjectPublicAppsLaunch/dashboard) and [crm-development-beta](https://tools.hubteam.com/gates/gates/crm-development-beta/dashboard). For webhooks, your developer account will need to be ungated to [Developers:ArbitraryCrmObjectWebhooks](https://tools.hubteam.com/gates/gates/Developers%3AArbitraryCrmObjectWebhooks/dashboard).
